 ...
 * this is hand-written SQL whose behaviour on conflict is the point, and Spring
 * Data has no way to express it.
 */
public interface TelemetryUpsertRepository {
     ...
     * on a live run, 1.04 on a backfill, both measured in Phase 3. The last
     * write wins, which is the one built on the most samples.
     */
    void upsert(
            Long machineId,
            Instant windowStart,
